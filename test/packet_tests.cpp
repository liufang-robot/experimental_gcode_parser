...
TEST(PacketTest, RapidModeInstructionDoesNotEmitSkipWarning) {
...
TEST(PacketTest, ReturnBoundaryInstructionsDoNotEmitPacketsOrWarnings) {
  const auto result = gcode::parseLowerAndPacketize("RET\nM17\nG1 X1\n");
...
TEST(PacketTest, SubprogramCallInstructionsDoNotEmitPacketsOrWarnings) {
  const auto result = gcode::parseLowerAndPacketize("L1000\nL2000 P2\nG1 X1\n");
